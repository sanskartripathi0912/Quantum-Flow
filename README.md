# Quantum-Flow — AI Workflow Builder

Quantum-Flow (originally NextFlow) is a visual workflow builder inspired by tools like Krea.ai. It allows users to create and execute AI workflows using a node-based interface.
